...
var CardBody = styled.div(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["height: 100%;\n border-radius: 5px;\n background-color: ",";\n ", "\n"], ["\n  ", "\n"])), function (_a) {
  var theme = _a.theme;
  return theme.card.cardBodyBackground;
}, space);
...
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush, isDark = _a.isDark, href = _a.href, cakePriceUsd = _a.cakePriceUsd, priceLink = _a.priceLink;
...
var MenuEntry = styled.div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n transition: filter 0.3s ease-in-out, box-shadow 0.3s ease-in-out;\n filter: brightness(","%);\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n filter: brightness(100%);\n    box-shadow: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), function(_a){
    ...
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? "inset 0px -2px 0px " + theme.colors.primary : "none");
}, function (_a) {
    var theme = _a.theme;
    ...
    return "inset 0px -2px 0px " + theme.colors.primary;
...
var AccordionContent = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  height: ", ";\n  transition: height 0.0s ease-out;\n  overflow: ",";\n  border-color: ", ";\n  border-style: solid;\n  border-width: 1px;\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: visible;\n  border-color: ", ";\n  border-style: solid;\n  border-width: 1px;\n"])), function (_a) {
    ...
    return (isOpen && isPushed ? "visible" : "hidden");
}, function (_a) {
    var isOpen = _a.isOpen, isPushed = _a.isPushed;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, { onMouseEnter: showSubmenu, onMouseOut: closeSubmenu },
        React.createElement(MenuEntry, { className: className },
            icon,
            React.createElement(LinkLabel, { isPushed: isPushed }, label),
            isOpen ? React.createElement(Icon$8,  { onMouseEnter: showSubmenu } ) : React.createElement(Icon$7, null)),
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
      cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
        React.createElement(Icon$v, { width: "35px", mr: "8px" }),
        React.createElement(Text, { color: "text", bold: true, fontSize: "16px" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
...
var StyledPanel = styled.div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n height: max-content;\n transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"])), function (_a) {
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Logo$1, { cakePriceUsd: cakePriceUsd, priceLink: priceLink, isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(PanelBody, __assign({}, { links: links, pushNav: setIsPushed, isPushed: isPushed } )),
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, login: login, logout: logout, links: links }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#131a35", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", tertiary: "#353547", text: "#fff", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "linear-gradient(245.22deg,#da2eef 7.97%,#2b6aff 49.17%,#39d0d8 92.1%)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#8c9ecd", background: "#131a35", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#fff", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "linear-gradient(245.22deg,#da2eef 7.97%,#2b6aff 49.17%,#39d0d8 92.1%)", gradients: {
...
var light$2 = {
    ...
    cardBodyBackground: "rgba(19, 26, 53, 0.9)",
};
var dark$2 = {
    background: darkColors.card,
    boxShadow: "0px 2px 12px -8px rgba(25, 19, 38, 0.1), 0px 1px 1px rgba(25, 19, 38, 0.05)",
